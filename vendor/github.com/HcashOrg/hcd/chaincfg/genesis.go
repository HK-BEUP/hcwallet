	...
	TxIn: []*wire.TxIn{
		{
			...
			SignatureScript: []byte("Vexon genesis block - vexonus.com exchange platform coin"),
			Sequence:        0xffffffff,
...
var genesisBlock = wire.MsgBlock{
	Header: wire.BlockHeader{
		...
		Timestamp:    time.Unix(1782518400, 0), // 2026-06-27 00:00:00 UTC
		Bits:         0x1e00ffff,
		SBits:        2 * 1e8, // 2 VEX
		Nonce:        0x00000000,
		StakeVersion: 0,
	...
	TxIn: []*wire.TxIn{
		{
			...
			SignatureScript: []byte("Vexon testnet genesis block - vexonus.com exchange platform coin"),
			Sequence:        0xffffffff,
		},
	},
	TxOut: []*wire.TxOut{
